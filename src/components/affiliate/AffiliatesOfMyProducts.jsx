    ...
    <div className="card">
        ...
        <div className="card-header d-flex flex-wrap align-items-center justify-content-between">
            ...
            <div className="dropdown">
                ...
                <li><Link className="dropdown-item" to="#">Gota Angolana</Link></li>
                <li><Link className="dropdown-item" to="#">Gota Nigeriana</Link></li>
                <li><Link className="dropdown-item" to="#">Gota Americana</Link></li>
                </ul>
            </div>
            ...
            <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="#">Aprovado</Link></li>
                <li><Link className="dropdown-item" to="#">Recusado</Link></li>
                <li><Link className="dropdown-item" to="#">Pendente</Link></li>
                </ul>
            </div>
            </div>
        </div>
      ...
      <div className="card-body">
        <table className="table bordered-table mb-0">
          ...
          <tbody>
            ...
            <tr>
              <td>01</td>
              <td><Link to="/view-profile" className="text-primary-600">
                <div className="d-flex align-items-center">
                    <img
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content radius-16 bg-base">
            <div className="modal-header">
              <h6 className="modal-title" id="modalAprovarLabel">Confirmar Aprovação</h6>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content radius-16 bg-base">
            <div className="modal-header">
              <h6 className="modal-title" id="modalReprovarLabel">Confirmar Reprovação</h6>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Fechar" />
            </div>
            <div className="modal-body">
